...
This appendix contains selected implementation excerpts from the project code.
The full implementation is available in the repository. Some excerpts are
shortened to keep the appendix readable. The research paper contains the
methodology and results; this appendix documents the main implementation
choices behind them.
...
\textit{Source: \texttt{src/bankruptcy\_ml/splitting.py}}
...
\textit{Source: \texttt{src/bankruptcy\_ml/preprocessing.py}}
...
\textit{Source: \texttt{src/bankruptcy\_ml/logistic\_models.py}}
...
\textit{Source: \texttt{src/bankruptcy\_ml/tree\_models.py}}
...
\textit{Source: \texttt{src/bankruptcy\_ml/final\_evaluation.py}}
...
\textit{Source: \texttt{src/bankruptcy\_ml/thresholds.py}}
...
root, the full pipeline can be run with:
